      ...
      <div className="contact-max-width thq-section-max-width">
        ...
        <div className="contact-row">
          <div className="contact-content2">
            <svg viewBox="0 0 1024 1024" className="thq-icon-medium" href={`mailto:${props.email1}`}>
            ...
            <div className="contact-contact-info1">
              ...
              <a className="contact-email thq-body-small" href={`mailto:${props.email1}`}>
                {props.email1}
              </a>
            </div>
          </div>
          <div className="contact-content4">
            <svg viewBox="0 0 1024 1024" className="thq-icon-medium" href={`tel:${props.phone1}`}>
            ...
            <div className="contact-contact-info2">
              ...
              <a className="contact-phone thq-body-small" href={`tel:${props.phone1}`}>
                {props.phone1}
              </a>
            </div>
          </div>
...
Contact.defaultProps = {
  content2:
    'Our customer service team is available to help you from Monday to Friday, 9 am to 5 pm.',
  email1: 'info@ryltenergy.com',
  address1: 'CIA Office Complex, Main Road, Sector - III, I.D.A Phase-II, Near Prof.Jaya sankar Circle, Cherlapally, R.R.District, Secunderabad, Telangana 500051',
  content3: 'For career opportunities, please visit our Careers page.',
